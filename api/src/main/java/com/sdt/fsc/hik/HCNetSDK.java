...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(DynamicLoadSDK.DLL_PATH+"HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//车牌识别（NET_VCA_PLATE_CFG）;
    ...
    public static final int NET_DVR_GET_RECORD_CHANNEL_INFO = 6013;//获取通道录像状态信息
...
//校时结构参数
    ...
    public static class NET_DVR_GBT28181_CHANINFO_CFG extends Structure {
        ...
        public char[] szVideoChannelNumID = new char[MAX_COMPRESSIONID_LEN]; /** 设备视频通道编码ID，64字节字符串，仅限数字**/
        public byte[] byRes = new byte[256]; //保留，置为0
    }
    //DVR设备参数
    ...
    public static class NET_DVR_ALARMINFO_V30 extends Structure {//上传报警信息(9000扩展)
        ...
        public byte[]  byAlarmRelateChannel= new byte[MAX_CHANNUM_V30];/*触发的+通道，为1表示对应录像, dwAlarmRelateChannel[0]对应第1个通道*/
...
//NET_DVR_Login()参数结构
    ...
    public static class NET_DVR_DEVICEINFO_V30 extends Structure
    {
        ...
        public  int wDevType;					    //设备型号
        public  byte bySupport3;                    //能力集扩展，位与结果：0- 不支持，1- 支持
        public  byte byMultiStreamProto;            //是否支持多码流，按位表示，位与结果：0-不支持，1-支持
        public  byte byStartDChan;					//起始数字通道号
        public  byte byStartDTalkChan;				//起始数字对讲通道号
        public  byte byHighDChanNum;				//数字通道个数
        public  byte bySupport4;                    //能力集扩展，按位表示，位与结果：0- 不支持，1- 支持
        public  byte byLanguageType;                //支持语种能力，按位表示，位与结果：0- 不支持，1- 支持
        public  byte byVoiceInChanNum;				//音频输入通道数
        public  byte byStartVoiceInChanNo;			//音频输入起始通道号
        public  byte[] byRes3 = new byte[2];		//保留
        public  byte byMirrorChanNum;				//镜像通道个数
        public  byte wStartMirrorChanNo;			//起始镜像通道号
    ...
    public static class NET_DVR_FINDDATA_V30 extends Structure {
        ...
        public byte byFileType;//文件类型,0-定时录像,6-手动录像
        public byte byQuickSearch;//（ISAPI登录不支持）0- 普通查询结果，1- 快速（日历）查询结果
        public byte byRes;
        public int dwFileIndex;//（ISAPI登录不支持）文件索引号
    ...
    public static class NET_DVR_ATMFINDINFO extends Structure //ATM文件查找条件结构体
    {
    ...
    public static class NET_DVR_SPECIAL_FINDINFO_UNION extends Union //智能查找条件联合体
    {
        public byte[] byLenth = new byte[8];
        public NET_DVR_ATMFINDINFO struATMFindInfo;
    }

    public static class NET_DVR_FILECOND_V40 extends Structure //录象文件查找条件结构
    {
        public int lChannel;//通道号
        public int dwFileType;//录象文件类型0xff－全部，0－定时录像,1-移动侦测 ，2－报警触发，3-报警|移动侦测 4-报警&移动侦测 5-命令触发 6-手动录像
        public int dwIsLocked;//是否锁定 0-正常文件,1-锁定文件, 0xff表示所有文件
        ...
        public byte byQuickSearch;//快速查询
        public byte bySpecialFindInfoType;//专有查询类型
        public int dwVolumeNum;//存档卷号，适用于CVR设备
        public byte[] byWorkingDeviceGUID = new byte[16];//工作机GUID
        public NET_DVR_SPECIAL_FINDINFO_UNION uSpecialFindInfo;//专有查询条件联合体
        public byte byStreamType;//码流类型
        public byte byAudioFile;//查找音频文件
        public byte[] bytes2 = new byte[30];
    ...
    public static class NET_DVR_IPDEVINFO_V31 extends Structure {
        public byte byEnable;			                            /* 该IP设备是否启用  */
        public byte byProType;			                            /* 协议类型 */
        public byte byEnableQuickAdd;			                        /* 支持快速添加 */
        public byte byCameraType;			                            /* 通道接入的相机类型 */
        public byte[] sUserName = new byte[NAME_LEN];		            /* 用户名 */
        public byte[] sPassword = new byte[PASSWD_LEN];		        /* 密码 */
        public byte[] byDomain = new byte[MAX_DOMAIN_NAME];		   /* 设备域名 */
        public NET_DVR_IPADDR  struIP;                             /* IP地址 */
        public short wDVRPort;                                     /* IP地址 */
        public byte[] szDeviceID = new byte[32];                /* 设备ID，GB28181协议接入时有效  */
        public byte byEnableTiming;			                    /* 启用NVR对IPC自动校时  */
        public byte byCertificateValidation;			           /* 是否启用证书 */
    }

    public static class NET_DVR_STREAM_MEDIA_SERVER_CFG extends Structure {   //流媒体服务器参数结构体
        public byte byValid;
        public byte[] byRes1 = new byte[3];
    ...
    public static class NET_DVR_DEV_CHAN_INFO extends Structure {   //前端设备信息结构体
    ...
    public static class NET_DVR_PU_STREAM_CFG extends Structure {   //前端设备信息结构体
        public int dwSize;
        public NET_DVR_STREAM_MEDIA_SERVER_CFG struStreamMediaSvrCfg;
        public NET_DVR_DEV_CHAN_INFO struDevChanInfo;
    }

    public static class NET_DVR_IPSERVER_STREAM extends Structure {   //IP Server模式配置结构体
        public byte byEnable;
        public byte[] byRes = new byte[3];
        public NET_DVR_IPADDR struIP;
        public short wPort;
        public short wDvrNameLen;
        public byte[] byDVRName = new byte[NAME_LEN];
        public short wDVRSerialLen;
        public short[] byRes1 = new short[2];
        public byte[] byDVRSerialNumber = new byte[SERIALNO_LEN];
    ...
    public static class NET_DVR_DDNS_STREAM_CFG extends Structure {   //IP Server+流媒体模式配置结构体
        public byte byEnable;
        public byte[] byRes1 = new byte[3];
        ...
        public short wDVRNameLen;
        public short wDVRSerialLen;
        public byte[] sDVRSerialNumber = new byte[SERIALNO_LEN];
        public byte[] sUserName = new byte[NAME_LEN];
        public byte[] sPassWord = new byte[PASSWD_LEN];
        public short wDVRPort;
    ...
    public static class NET_DVR_PU_STREAM_URL extends Structure {   //URL取流配置结构体
        public byte byEnable;
    ...
    public static class NET_DVR_HKDDNS_STREAM extends Structure {   //hiDDNS取流配置结构体
        public byte byEnable;
        public byte[] byRes = new byte[3];
    ...
    public static class NET_DVR_IPCHANINFO_V40 extends Structure {   //IP通道信息（扩展）结构体
        public byte byEnable;
        public byte byRes1;
        public short wIPID;
        public int dwChannel;
    ...
    public static class NET_DVR_GET_STREAM_UNION extends Union {    //取流方式联合体
    ...
    public static class NET_DVR_STREAM_MODE extends Structure {/* 取流模式 */
        public byte byGetStreamType;			                        /* 取流方式 */
        public byte[] byRes = new byte[3];			                    /* 保留 */
        public NET_DVR_GET_STREAM_UNION unionSTREAM_UNION;
    }

    public static class NET_DVR_IPPARACFG_V40 extends Structure {/* IP接入配置结构 */
        public int dwSize;			                            /* 结构大小 */
        ...
        public byte[] byAnalogChanEnable = new byte[MAX_CHANNUM_V30];	/* 模拟通道资源是否启用 */
        public NET_DVR_IPDEVINFO_V31[] struIPDevInfo = new NET_DVR_IPDEVINFO_V31[64];	 /* IP设备信息 */
        public NET_DVR_STREAM_MODE[] struStreamMode = new NET_DVR_STREAM_MODE[MAX_CHANNUM_V30]; /* 取流模式 */
        public byte[] byRes2 = new byte[20];			                            /* 保留 */
    }
    ...
    //CVR
    public static class NET_DVR_MANUAL_RECORD_PARA extends Structure {//手动录像参数结构体
        public NET_DVR_STREAM_INFO struStreamInfo;  //流ID信息
        public NativeLong lRecordType; //录像类型：0- 手动录像，1- 移动侦测录像，2- 信号量IO报警录像，3- 遮挡报警录像
        public byte[] byRes = new byte[32];
    }
    ...
    boolean  NET_DVR_FindClose_V40(NativeLong lFindHandle);
...
//2007-11-30 V211支持以下接口 //11
    ...
    //远程控制设备端手动录像
    boolean NET_DVR_StartManualRecord(NativeLong lUserID,NET_DVR_MANUAL_RECORD_PARA pRecordPara);
    boolean NET_DVR_StopManualRecord(NativeLong lUserID,NET_DVR_STREAM_INFO pIDInfo);
    //ISAPI协议命令透传
    ...
    public static class NET_DVR_CHANS_RECORD_STATUS extends Structure   //通道录像状态信息结构体
    {
        public byte byValid;                //是否有效：0- 无效，1- 有效
        public byte byRecord;               //录像状态(只读)：0- 不在录像，1- 在录像，2- 空闲，3- 无连接，4- 无输入视频，5- 未加载，6- 存档中，7- 回传中，8- 用户名或密码错，9- 未验证，10- 存档中和录像中，11- 录像回传中和录像中，12-token认证失败
        public short wChannelNum;             //通道号，0xffff表示无效
        public int dwRelatedHD;             //关联磁盘
        public byte byOffLineRecord;        //断网录像功能：0- 关闭，1- 开启
        public byte[] byRes = new byte[7];  //保留

    }

    public static class NET_DVR_CHAN_GROUP_RECORD_STATUS extends Structure  //一组通道录像状态信息结构体
    {
        public int dwSize;        //结构体大小
        public NET_DVR_CHANS_RECORD_STATUS[] struChanStatus = new NET_DVR_CHANS_RECORD_STATUS[64];  //通道录像状态信息，一组64个通道
    }
    ...
    {
        PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(DynamicLoadSDK.DLL_PATH+"PlayCtrl.dll",
                PlayCtrl.class);
